...
const Postman = ({ rowData }) => {
  ...
  }, [bodyType, authoriziedType, authData1, raw, jsonData, bodyBinaryFileName]);
  ...
  useEffect(() => {
    if (bodyType === "form-data") {
      ...
      const base64Data = arrayBufferToBase64(bodyBinaryFileName);

      // Now, send the base64 data in the POST request
      const requestBodyData1 = JSON.stringify({
        bodyBinaryFileName: base64Data, // Send the base64 string, not ArrayBuffer
      });
      setRequestBodyData(requestBodyData1);
    } else {
      setRequestBodyData({});
    }
  }, [
