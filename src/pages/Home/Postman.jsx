...
const Postman = ({
  ...
  // console.log("rowData:------------>>>", rowData);
  // console.log("initialData:------------>>>", initialData);
  // console.log("trigredMethod:------------>>>", trigredMethod);
  // console.log("trigredFileName:------------>>>", trigredFileName);
  // console.log("trigredFileName1:------------>>>", trigredFileName1);
  ...
  const handleSaveData = async () => {
    ...
    link.download = `request-data-${Date.now()}.json`; // file name with timestamp
    ...
    // =========  Download json file which save in s3 buket ================
    const fileName = `api-request-${Date.now()}.json`;

    // const params = {
    //   Bucket: 'prodes-vertex-emailmodule', // 🔁 e.g. vertex-storage
    ...
    //   Bucket: 'prodes-vertex-emailmodule',
    //   Key: fileName,
    //   Body: fileContent,
    //   Expires: 300,               // seconds
    //   ContentType: 'application/json',
    ...
    try {
      ...
      // const uploadResult = await s3.upload(url).promise();
      console.log("✅ Upload successful:", url);
      alert("Data saved to S3 successfully!");
    } catch (error) {
      console.error("❌ Upload failed:", error);
      alert("Failed to save data to S3");
    }
  };
