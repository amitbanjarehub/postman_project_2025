...
const HeaderHidden = ({ headerData, headerJsonData, setHeaderJsonData}) => {
  ...
  const [rows, setRows] = useState(() => {
    const savedRows = localStorage.getItem("headerHiddenRows");
    return savedRows
  ...
  }, [selectedRows1, selectedRows, setSelectedRows, headerJsonData, setHeaderJsonData]);
